...
namespace Alamut.Data.EF.Test
{
    public class KeyLessRepositoryTest
    {
        ...
        [Fact]
        public async void Repository_GetByIds_ReturnEntity()
        {
            // arrange
            var repository = new Repository<Story>(_dbContext);
        ...
        [Fact]
        public async void Repository_GenericUpdate_EntityUpdated()
        {
            // arrange
            var repository = new Repository<Blog>(_dbContext);
            DbHelper.CleanBlog(_dbContext);
        ...
        [Fact]
        public async void Repository_DeleteById_EntityDeleted()
        {
            // arrange
            var repository = new Repository<Blog>(_dbContext);
            var expected = DbHelper.SeedSingleBlog(_dbContext);
